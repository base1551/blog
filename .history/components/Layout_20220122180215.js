...
export default function Layout({ children, title = "HP by Nextjs" }) {
  ...
  return (
    <div className="flex flex-col fustify-center items-center  min-h-screen text-gray-600 text-sm font-mono">
      ...
      <div className="grid grid-cols-12 w-screen flex-grow">
        <main className="grid lg:col-span-9 col-span-12">{children}</main>
        {/* サイドバー */}
        <div className="grid lg:col-span-3 col-span-12">
          <Profile></Profile>
          {/* <Skill></Skill> */}
        </div>
      </div>
