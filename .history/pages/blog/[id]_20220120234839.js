    ...
    <Layout className={styles.main}>
      <div className="grid grid-cols-12">
        <div className="grid lg:col-span-9 col-span-12 bg-white shadow-xl m-5 p-8 rounded">
          ...
          <div className="grid grid-cols-12 bg-gray-50 px-10 py-6">
            <div className="">
              {/* <img */}
              {/* className="object-cover w-full shadow-sm h-full" */}
              {/* src={blog.eye_catch.url} */}
              {/* /> */}
              <div className="grid col-span-12 px-10 py-6 bg-gray-50 sm:text-3xl md:text-3xl lg:text-3xl xl:text-4xl font-bold text-blue-500">
                {blog.title}
              </div>
              {/* {blog.category && (
              ...
              <div className="grid col-span-12 px-10 py-6 bg-gray-50">
                {blog.body}
              </div>
            </div>
          </div>
